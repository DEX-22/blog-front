<template> 
  <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
    ...
    <textarea class="description bg-gray-100 sec p-3   border border-gray-300 outline-none" rows="2" placeholder="Describe everything about this post here"></textarea>
